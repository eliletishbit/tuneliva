...
const SHOWCASE_CREATIVES = [
  ...
  {
    id: "academy",
    title: "Académie Produits Digitaux",
    subtitle: "Formation VIP • Vente internationale & Diaspora",
    theme: "Or Royal & Noir Carbone",
    stats: "Panier moyen : 150 000 FCFA",
    imageUrl: "https://images.unsplash.com/photo-1531482615713-2afd69097998?w=1000&auto=format&fit=crop&q=80",
    color: "#EAB308",
    prompt: "Bâtir la souveraineté par les produits digitaux académie",
  },
  {
    id: "momo",
    title: "MomoOpti – Réseau MoMo",
    subtitle: "Comparateur frais MTN / Moov / Celtiis",
    theme: "Fintech Mint & Obsidian",
    stats: "Temps de chargement : 340ms",
    imageUrl: "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=1000&auto=format&fit=crop&q=80",
    color: "#00F5A0",
    prompt: "Choisir le bon réseau Mobile Money pour payer moins",
  },
];
